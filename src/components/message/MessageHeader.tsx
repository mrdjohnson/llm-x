...
const MessageHeader = ({
  ...
  return (
    <div
      className={twMerge(
        'group sticky top-0 z-10 mb-2 flex flex-row gap-2 bg-gradient-to-b from-base-100 from-60% to-transparent align-baseline transition-colors duration-300 ease-in-out hover:bg-base-100',
